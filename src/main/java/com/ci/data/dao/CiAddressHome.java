...
import com.ci.data.Address;

/**
 * Home object for domain model class CiAddress.
 * @see .CiAddress
 * @author itspritish
 */
public class CiAddressHome {
	...
	public void persist(Address transientInstance) {
		log.debug("persisting CiAddress instance");
		try {
	...
	public void remove(Address persistentInstance) {
		log.debug("removing CiAddress instance");
		try {
	...
	public Address merge(Address detachedInstance) {
		log.debug("merging CiAddress instance");
		try {
	...
	public Address findById(int id) {
		log.debug("getting CiAddress instance with id: " + id);
		try {
